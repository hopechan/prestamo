<?php
    ...
    if (isset($s)) {
        ...
        $numClientes = count($Cliente);
                ...
                for ($i = 0; $i < $numClientes; $i++) {
                    ...
                    $mensaje .= '<td>'.'<a href="detalleCliente.php"><button class="btn btn-sm btn-info"><i class="glyphicon glyphicon-eye-open"></i></button></a>'
                    .'<a href="eliminar.php"><button class="btn btn-sm btn-info" onClick="eliminar()"><i class="glyphicon glyphicon-remove"></i></button></a></tr>';
                    $mensaje .= '</tr>';
                }
    }
    ...
    $mensaje .= "</tbody>";
    echo $mensaje;
	//header("Location: webclientebusqueda.php");
